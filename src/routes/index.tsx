    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path={ROUTES.PROFILE_MEN.ROOT} element={<Profile />}>
          <Route
            index
            element={<Navigate to={ROUTES.PROFILE_MEN.USER_ACCOUNT} />}
          />
          <Route
            path={ROUTES.PROFILE_MEN.USER_ACCOUNT.split("/").pop()}
            element={<IconUserAccount />}
          />
        ...
        <Route
          path={ROUTES.AUTHENTICATION_BASIC}
          element={<AuthenticationBasic />}
        />
        <Route
          path={ROUTES.AUTHENTICATION_ADVANCED}
        ...
        <Route path={ROUTES.TRANSACTION.ROOT} element={<TransactionLayout />}>
          <Route index element={<CryptoPage />} /> {/* /history */}
          <Route
            path={ROUTES.TRANSACTION.CRYPTO_HISTORY}
            element={<CryptoPage />}
          />{" "}
          {/* /history/Crypto */}
          <Route
            path={ROUTES.TRANSACTION.TOMAN_HISTORY}
            element={<TomanPage />}
          />{" "}
          {/* /history/toman */}
          <Route
            path={ROUTES.TRANSACTION.ORDER_HISTORY}
            element={<OrderPage />}
          />{" "}
          {/* /history/order */}
        </Route>
        ...
        <Route
          ...
          element={<ConnectedDevicesLayout />}
        />
        {/* <Route path={ROUTES.BANK_CARDS} element={<BankCardsPage />} />
        <Route path={ROUTES.Cards_Manager} element={<CardsManager />} /> */}
        <Route
          path={ROUTES.BANK_CARDS_CONTAINER}
          element={<BankCardsContainer />}
        />

        <Route path={ROUTES.DEPOSIT_GATEWAY} element={<DepositForm />} />
        <Route
          path={ROUTES.DEPOSIT_IDENTIFIER}
          element={<DepositPage selected="identifier" />}
        />
        <Route
          path={ROUTES.DEPOSIT_CARD}
          element={<DepositPage selected="card" />}
        />
        <Route
          path={ROUTES.DEPOSIT_RECEIPT}
          element={<DepositPage selected="receipt" />}
        />
        <Route
          path={ROUTES.DEPOSIT_WALLET}
          element={<DepositPage selected="wallet" />}
        />

        <Route
          path={ROUTES.DEPOSIT_TXID}
          element={<DepositPage selected="txid" />}
        />
