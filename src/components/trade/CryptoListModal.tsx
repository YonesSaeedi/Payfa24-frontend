...
const CryptoListModal = ({ setIsCryptoListModalOpen, cryptoListData, setCurrentCryptoCurrency, isCryptoListLoading, digitalCryptoListData, isSell }: CryptoListModalProps) => {
