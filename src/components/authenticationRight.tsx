...
export default function AuthenticationRight({ step, onStart }: Props) {
  return (
    <div className={`w-full h-full flex flex-col gap-6 items-end  ${step === 0 ? "flex" : "hidden lg:flex"}`}>
      {/* سطح 1 */}
      <div className="lg:w-5/6 py-5 lg:py-6 w-full border-solid border-blue2 rounded-lg border-[1px] md:flex flex-col  dark:text-white justify-center sm:justify-end">
