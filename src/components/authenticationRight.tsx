...
export default function AuthenticationRight({ step, onStart }: Props) {
  return (
    <div className={`w-full h-full flex flex-col gap-6 items-end  ${step === 0 ? "flex" : "hidden lg:flex"}`}>
      {/* سطح 1 */}
  <div className="lg:w-5/6 w-full max-w-full flex-shrink-0 py-5 lg:py-6 border-solid border-blue2 rounded-lg border-[1px] md:flex flex-col dark:text-white justify-center sm:justify-end min-h-[300px]">


        <h1 className="text-right mb-5 lg:pe-6 pe-[22px] text-blue2 font-medium lg:text-xl text-lg">سطح {toPersianDigits(1)} : احراز هویت پایه</h1>
    ...
    احراز هویت
      ...
      <div className="lg:w-5/6  text-gray15 w-full items-end mb-5 border-solid border-gray49 rounded-lg border-[1px] md:flex flex-col p-6 justify-center sm:justify-end">
        ...
        <div dir="rtl">
          ...
          <ul className="list-disc list-inside text-right text-gray15 lg:text-base text-sm" dir="rtl">
...
//       {/* سطح 1 */}
//       <div className="lg:w-5/6 w-full max-w-full flex-shrink-0 py-5 lg:py-6 border-solid border-blue2 rounded-lg border-[1px] md:flex flex-col dark:text-white justify-center sm:justify-end min-h-[300px] transition-all duration-300 flex">
//         <h1 className="text-right mb-5 lg:pe-6 pe-[22px] text-blue2 font-medium lg:text-xl text-lg">
//           سطح {toPersianDigits(1)} : احراز هویت پایه
//         </h1>
//         <div className="flex mb-2 lg:pe-6 pe-5 flex-row items-center justify-end lg:gap-2 gap-[6px]">
//           <span className="mr-2 text-black1">ثبت ایمیل</span>
//           <span className="icon-wrapper w-7 h-7 text-blue2">
...
//         </div>
//         <div dir="rtl">
//           <p className="text-right lg:mt-5 mt-4 lg:pr-6 pr-5 lg:mb-[6px] mb-1 lg:text-lg text-base font-medium">
//             دسترسی ها :
//           </p>
//           <ul className="list-disc list-inside text-right text-gray15 lg:pr-6 pr-5">
//             <li>مشاهده قیمت‌ها</li>
...
//         <h1 className="text-right lg:text-xl text-lg font-medium text-gray5">
//           سطح {toPersianDigits(2)} : احراز هویت پیشرفته
//         </h1>
//         <div className="flex flex-row items-center justify-end mt-5 mb-2 lg:gap-2 gap-[6px]">
//           <span className="mr-2 lg:text-base text-sm">ثبت مدرک شناسایی</span>
//           <span className="icon-wrapper w-7 h-7">
...
//         </div>
//         <div dir="rtl">
//           <p className="lg:mt-5 mt-4 lg:mb-[6px] mb-1 lg:text-lg text-base font-medium">
//             دسترسی ها :
//           </p>
