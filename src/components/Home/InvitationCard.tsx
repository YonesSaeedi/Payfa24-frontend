...
function InvitationCard() {
  ...
  className="bg-blue2 border border-transparent font-bold text-base text-white rounded-lg w-full py-2 
             hover:border-blue2 hover:text-blue2 hover:bg-transparent transition-all duration-200 ease-in"
>
  دعوت
</Link>
