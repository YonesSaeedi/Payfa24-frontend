...
// export default function StepInvite({ onNext }: StepInviteProps) {
...
//   const [ setIsOtpError] = useState<boolean>(false);
...
export type StepInviteFormData = {
  email: string;
  inviteCode?: string ; 
};
...
export default function StepInvite({ onNext }: StepInviteProps) {
  ...
  const {
    ...
    defaultValues: {
      email: "",
      inviteCode: undefined, // optional defaultValue
    },
  });
