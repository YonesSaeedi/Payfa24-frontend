...
//     .slice(0, 16)
//     .replace(/(\d{4})/g, "$1-")
//     .replace(/-$/, ""); // این خط جدید برای نمایش خطوط زیرین اضافه شده است
...
//         "http://localhost:5173/account/credit-card",
//         payload,
//         {
//           headers: {
...
//       setErrorMsg("");
//     } catch (error) {
//       console.error("Error submitting card number:", error);
...
//         } else {
//           setErrorMsg("خطایی در ارتباط با سرور رخ داده است.");
//         }
//       } else {
//         setErrorMsg("خطایی در ارتباط با سرور رخ داده است.");
//       }
...
//                 label="شماره کارت"
//                 type="text"
//                 error={errors.CardNumber?.message || errorMsg}
//                 {...field}
//                 onChange={(e) => {
//                   const formatted = formatCardNumber(e.target.value);
//                   setValue("CardNumber", formatted, {
...
//                   });
//                 }}
//                 value={CardNumberValue || "_ _ _ _  _ _ _ _  _ _ _ _  _ _ _ _"}
//                 labelBgClass="bg-gray9 "
//                 className="input-card"
//               />
//             )}
        ...
        >
          ...
          <div className="flex gap-5 items-center lg:mt-22 mt-12 mb-60 w-full lg:flex-row flex-col">
            ...
            <button
              type="submit"
              className="lg:w-1/2 w-full h-[40px] lg:h-[56px] bg-blue1 font-bold text-white2 rounded-lg"
              disabled={submitCardMutation.isLoading}
            >
              {submitCardMutation.isLoading ? "در حال تایید..." : "تایید"}
            </button>
          </div>
        </form>
        {isModalOpen && (
