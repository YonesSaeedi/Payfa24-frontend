...
export default function CardToCardTransfer() {
  ...
  const setPresetAmount = (amount: number) => {
    setValue("amount", amount * 1000000, { shouldValidate: true }); // مقدار به تومان
  };
  ...
  const onSubmit = async (data: CardToCardRequestData) => {
    ...
    try {
      ...
      const axiosError = error as AxiosError<{ msg?: string }>;
      const serverMsg = axiosError.response?.data?.msg || "خطا در اتصال به سرور. دوباره امتحان کنید. ⚠️";
    ...
    <div className="w-full lg:px-7 my-10" dir="rtl">
            ...
            <Controller
              ...
              render={({ field }) => (
                <>
                  ...
                  />
                  {errors.card && (
                    <p className="text-red1 text-sm mt-1">{errors.card.message}</p>
                  )}
                  {cards.length === 0 && (
      ...
      <div className="flex gap-2 items-center mb-12 flex-wrap justify-center mt-4 lg:mt-6">
          ...
          <div className="mt-40">
            <button
              ...
              className={`text-white2 bg-blue2 w-full py-3 font-bold text-lg rounded-lg ${
                isSubmitting || cards.length === 0 ? "opacity-50 cursor-not-allowed" : ""
              }`}
            >
        ...
        <>
            ...
            <div className="space-y-6 lg:text-lg text-sm">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center font-monospace">
                  ...
                  <span className="icon-wrapper w-7 h-7">{transactionData.fromBankIcon}</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center font-monospace">
                  ...
                  <span className="icon-wrapper w-7 h-7">{getBankIcon(transactionData.toBank)}</span>
                </div>
              </div>
          ...
          <div dir="rtl" className="bg-orange5 rounded-xl p-4 text-sm text-left space-y-4">
