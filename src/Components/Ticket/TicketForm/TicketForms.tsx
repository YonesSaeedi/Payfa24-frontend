  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        {/* آپلود فایل */}
        <div className="relative w-full mt-5">
          <label className="absolute right-3 text-xs -top-2 px-1 z-40 bg-gray38 lg:bg-gray43 text-gray12">
            فایل پیوست
          </label>
          <Controller
            name="file"
            control={control}
            render={({ field }) => (
              <div className="w-full border rounded-md px-3 py-4 flex justify-between items-center border-gray12">
                <label className="flex items-center gap-2 h-[36px] rounded-[10px] cursor-pointer">
