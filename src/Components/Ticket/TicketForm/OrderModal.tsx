...
export default function OrderModal({ orders, isLoading, onSelectOrder, onClose }: OrderModalProps) {
  ...
  return (
    <div dir="rtl" className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
      ...
      <div ref={modalRef} className="bg-white8 rounded-2xl shadow-lg p-2 z-10 flex flex-col" style={{ width: "480px", height: "585px" }} onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center border-gray-100 px-2 pt-4 pb-6">
