// components/crypto/CryptoWithdrawModal.tsx
...
type CryptoWithdrawModalProps = {
  setIsModalOpen: Dispatch<SetStateAction<boolean>>;
  cryptoListData: CryptoItem[];
  cryptoWithdrawData: Record<string, Coin>;
...
const CryptoWithdrawModal = ({
  ...
  // merge cryptoListData with cryptoWithdrawData
  const mergedData: CryptoItem[] = cryptoListData.map((item) => {
    const coin = cryptoWithdrawData[item.symbol];
    return {
      ...item,
